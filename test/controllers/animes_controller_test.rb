...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { author: @anime.author, genre: @anime.genre, producer: @anime.producer, release: @anime.release, title: @anime.title, url: @anime.url } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { author: @anime.author, genre: @anime.genre, producer: @anime.producer, release: @anime.release, title: @anime.title, url: @anime.url } }
